...
## Intent
Control external dependencies, time, randomness, and concurrency so feedback remains repeatable and fast enough for normal development.
...
## Related skills
- [`choose-the-right-test-scope`](../choose-the-right-test-scope/SKILL.md)
