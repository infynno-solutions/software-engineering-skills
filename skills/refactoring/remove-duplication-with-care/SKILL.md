...
## Intent
Remove harmful duplication when it creates divergent maintenance burden, but preserve intentional duplication when sharing would create stronger coupling.
...
- [`extract-and-recompose-responsibilities`](../extract-and-recompose-responsibilities/SKILL.md)
