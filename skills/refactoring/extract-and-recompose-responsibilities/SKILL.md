...
## Intent
Use extraction, movement, and recomposition refactorings to restore cohesive functions/classes and improve responsibility boundaries.
...
## Related skills
- [`remove-duplication-with-care`](../remove-duplication-with-care/SKILL.md)
- [`simplify-conditionals-and-control-flow`](../simplify-conditionals-and-control-flow/SKILL.md)
