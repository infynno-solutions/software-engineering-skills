...
## Intent
Keep externally observable behavior unchanged while improving internal structure; separate behavior changes from structural changes.
...
## Related skills
- [`refactor-in-small-safe-steps`](../refactor-in-small-safe-steps/SKILL.md)
- [`use-tests-as-a-refactoring-safety-net`](../use-tests-as-a-refactoring-safety-net/SKILL.md)
