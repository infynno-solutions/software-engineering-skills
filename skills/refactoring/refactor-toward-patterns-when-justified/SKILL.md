...
## Intent
Introduce a pattern only when repeated variation and forces justify it; use refactoring to evolve toward the pattern incrementally.
...
## Related skills
- [`reshape-interfaces-and-dependencies`](../reshape-interfaces-and-dependencies/SKILL.md)
- [`evolve-architecture-incrementally`](../evolve-architecture-incrementally/SKILL.md)
