...
## Intent
Select storage mechanisms based on workload shape, access patterns, latency, throughput, durability, and operational constraints.
...
## Related skills
- [`choose-data-models-from-access-patterns`](../choose-data-models-from-access-patterns/SKILL.md)
