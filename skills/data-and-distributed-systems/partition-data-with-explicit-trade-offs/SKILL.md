...
## Intent
Partition data to scale load and ownership while accounting for hot spots, rebalancing, routing, and cross-partition operations.
...
## Related skills
- [`design-replication-for-the-required-guarantees`](../design-replication-for-the-required-guarantees/SKILL.md)
- [`define-transaction-boundaries-and-isolation`](../define-transaction-boundaries-and-isolation/SKILL.md)
