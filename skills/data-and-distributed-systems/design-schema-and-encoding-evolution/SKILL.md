...
## Intent
Treat data schemas and encoded records as compatibility boundaries that must evolve safely across time and versions.
...
## Related skills
- [`choose-storage-engines-by-workload`](../choose-storage-engines-by-workload/SKILL.md)
