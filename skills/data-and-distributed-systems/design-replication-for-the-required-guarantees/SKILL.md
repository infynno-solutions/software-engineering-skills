...
## Intent
Choose leader-based, multi-leader, leaderless, or other replication strategies according to availability, latency, consistency, and operational needs.
...
## Related skills
- [`design-schema-and-encoding-evolution`](../design-schema-and-encoding-evolution/SKILL.md)
- [`partition-data-with-explicit-trade-offs`](../partition-data-with-explicit-trade-offs/SKILL.md)
