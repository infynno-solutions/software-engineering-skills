...
## Intent
Use transactions where atomicity and isolation simplify correctness, and choose isolation levels based on anomalies the application can tolerate.
...
- [`reason-explicitly-about-consistency`](../reason-explicitly-about-consistency/SKILL.md)
