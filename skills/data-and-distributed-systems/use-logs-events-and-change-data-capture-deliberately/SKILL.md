...
## Intent
Use immutable logs, event streams, or change-data-capture when they provide useful integration, auditability, replay, or derived-state capabilities.
...
- [`avoid-distributed-coordination-unless-justified`](../avoid-distributed-coordination-unless-justified/SKILL.md)
