...
## Intent
Choose boundaries based on axes of change, coupling, ownership, and required independence rather than fashionable topology.
...
- [`avoid-premature-distribution`](../avoid-premature-distribution/SKILL.md)
