...
## Intent
Arrange source dependencies so high-level policy remains independent of volatile details and dependency arrows follow intended stability.
...
## Related skills
- [`identify-and-place-architectural-boundaries`](../identify-and-place-architectural-boundaries/SKILL.md)
- [`design-for-independent-development`](../design-for-independent-development/SKILL.md)
