...
## Intent
Keep persistence mechanisms behind application-facing abstractions when business rules should not depend on a particular database technology.
...
- [`design-testable-architecture`](../design-testable-architecture/SKILL.md)
