...
## Intent
Keep business rules and application policy insulated from volatile mechanisms such as UI, frameworks, databases, and infrastructure.
...
## Related skills
- [`design-around-the-system-lifecycle`](../design-around-the-system-lifecycle/SKILL.md)
