...
## Intent
Create deployment boundaries when independent release, fault isolation, or scaling actually matters; otherwise avoid needless distribution.
...
- [`keep-frameworks-as-details`](../keep-frameworks-as-details/SKILL.md)
