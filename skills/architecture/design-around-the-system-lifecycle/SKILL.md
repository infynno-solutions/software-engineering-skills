...
## Intent
Treat development, deployment, operation, and maintenance as architectural concerns; optimize the architecture for the system’s lifetime, not merely initial correctness.
