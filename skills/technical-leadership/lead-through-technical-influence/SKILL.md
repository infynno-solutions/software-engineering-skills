...
## Intent
Lead through clear reasoning, credibility, service to the team, and influence rather than relying on hierarchy.
...
## Related skills
- [`take-technical-ownership`](../take-technical-ownership/SKILL.md)
- [`make-and-revisit-technical-decisions`](../make-and-revisit-technical-decisions/SKILL.md)
