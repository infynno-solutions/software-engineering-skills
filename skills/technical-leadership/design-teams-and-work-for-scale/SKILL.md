...
## Intent
Partition problem spaces, ownership, and decision-making so teams can operate effectively as systems and organizations grow.
...
## Related skills
- [`create-healthy-review-and-feedback-culture`](../create-healthy-review-and-feedback-culture/SKILL.md)
- [`measure-engineering-outcomes-with-care`](../measure-engineering-outcomes-with-care/SKILL.md)
