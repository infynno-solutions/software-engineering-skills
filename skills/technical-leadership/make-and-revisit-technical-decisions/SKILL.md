...
## Intent
Make timely decisions using available evidence, expose assumptions, and revisit them when new information changes the trade-offs.
...
## Related skills
- [`lead-through-technical-influence`](../lead-through-technical-influence/SKILL.md)
- [`communicate-trade-offs-and-context`](../communicate-trade-offs-and-context/SKILL.md)
