...
## Related skills
- [`document-decisions-and-system-context`](../document-decisions-and-system-context/SKILL.md)
- [`revisit-process-rules-using-evidence`](../revisit-process-rules-using-evidence/SKILL.md)
