...
## Intent
Make retried or duplicated requests converge on the same intended result whenever practical.
...
## Related skills
- [`use-timeouts-and-deadlines`](../use-timeouts-and-deadlines/SKILL.md)
- [`isolate-failures-and-limit-blast-radius`](../isolate-failures-and-limit-blast-radius/SKILL.md)
