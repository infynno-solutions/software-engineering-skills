...
## Intent
Partition resources and failure domains so one component, tenant, workload, or dependency cannot cascade through the whole system.
...
- [`design-for-recovery`](../design-for-recovery/SKILL.md)
