...
## Intent
Design with the assumption that some parts of a distributed system can fail while others continue running.
...
## Related skills
- [`make-systems-operable`](../make-systems-operable/SKILL.md)
- [`treat-human-error-as-a-failure-mode`](../treat-human-error-as-a-failure-mode/SKILL.md)
