...
## Intent
Constrain dangerous actions, automate repetitive operations, and build recovery mechanisms for operator mistakes.
...
## Related skills
- [`reason-about-partial-failure`](../reason-about-partial-failure/SKILL.md)
- [`automate-reliability-work`](../automate-reliability-work/SKILL.md)
