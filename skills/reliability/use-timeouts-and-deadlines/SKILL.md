...
## Intent
Avoid indefinite waiting by setting explicit time budgets and propagating them through dependent operations.
...
## Related skills
- [`make-retries-safe-and-bounded`](../make-retries-safe-and-bounded/SKILL.md)
- [`design-idempotent-operations`](../design-idempotent-operations/SKILL.md)
