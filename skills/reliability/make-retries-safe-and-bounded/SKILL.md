...
## Intent
Retry only operations for which repeated execution is safe or controlled, and bound attempts with backoff and deadlines.
...
## Related skills
- [`design-for-failure`](../design-for-failure/SKILL.md)
